import { CardContainer, ElementSkeleton, TextSkeleton } from "@/hooks/utils";
...
export const SkeletonProject = () => {
    return (
        <CardContainer>
            <a
                href="/#link"
                className="h-full flex flex-col justify-between block p-7 text-gray-500"
            >
                <div>
                    ...
                    <TextSkeleton>
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit onej.
                    </TextSkeleton>
                    <TextSkeleton>
